...
export const Route = createRootRouteWithContext<MyRouterContext>()({
  ...
  head: ({ loaderData }) => {
    ...
    const metadata: OGMetaTags = {
      title: 'Arc Testnet Wallet Roaster',
      description:
        'A fun app that analyzes your Arc testnet wallet transactions and tokens, then roasts you with hilarious AI-generated commentary based on your on-chain activity.',
      image: ogImageUrl,
    ...
    return {
      ...
      links: [
        ...
        {
          rel: 'stylesheet',
          href: 'https://fonts.googleapis.com/css2?family=Bebas+Neue&family=DM+Sans:ital,opsz,wght@0,9..40,300;0,9..40,400;0,9..40,500;1,9..40,300;1,9..40,400&family=JetBrains+Mono:wght@400;700&display=swap',
        },
      ],
      scripts: [...scripts],
    }
